...
#ifndef VERILATED_VTOOLS___024ROOT_H_
#define VERILATED_VTOOLS___024ROOT_H_  // guard

#include "verilated.h"

class Vtools__Syms;

class Vtools___024root final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vtools___024root(Vtools__Syms* symsp, const char* v__name);
    ~Vtools___024root();
    VL_UNCOPYABLE(Vtools___024root);
