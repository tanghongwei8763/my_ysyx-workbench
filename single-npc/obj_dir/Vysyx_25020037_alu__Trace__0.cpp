...
void Vysyx_25020037_alu___024root__trace_chg_sub_0(Vysyx_25020037_alu___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vysyx_25020037_alu___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_25020037_alu___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    Vysyx_25020037_alu___024root__trace_chg_sub_0((&vlSymsp->TOP), bufp);
}

void Vysyx_25020037_alu___024root__trace_chg_sub_0(Vysyx_25020037_alu___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vysyx_25020037_alu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_25020037_alu___024root__trace_chg_sub_0\n"); );
    // Init
    ...
    bufp->chgIData(oldp+118,(vlSelf->inst),32);
    bufp->chgIData(oldp+119,(vlSelf->pc),32);
    bufp->chgIData(oldp+120,(vlSelf->regs[0]),32);
    bufp->chgIData(oldp+121,(vlSelf->regs[1]),32);
    bufp->chgIData(oldp+122,(vlSelf->regs[2]),32);
    bufp->chgIData(oldp+123,(vlSelf->regs[3]),32);
    bufp->chgIData(oldp+124,(vlSelf->regs[4]),32);
    bufp->chgIData(oldp+125,(vlSelf->regs[5]),32);
    bufp->chgIData(oldp+126,(vlSelf->regs[6]),32);
    bufp->chgIData(oldp+127,(vlSelf->regs[7]),32);
    bufp->chgIData(oldp+128,(vlSelf->regs[8]),32);
    bufp->chgIData(oldp+129,(vlSelf->regs[9]),32);
    bufp->chgIData(oldp+130,(vlSelf->regs[10]),32);
    bufp->chgIData(oldp+131,(vlSelf->regs[11]),32);
    bufp->chgIData(oldp+132,(vlSelf->regs[12]),32);
    bufp->chgIData(oldp+133,(vlSelf->regs[13]),32);
    bufp->chgIData(oldp+134,(vlSelf->regs[14]),32);
    bufp->chgIData(oldp+135,(vlSelf->regs[15]),32);
    bufp->chgIData(oldp+136,(vlSelf->regs[16]),32);
    bufp->chgIData(oldp+137,(vlSelf->regs[17]),32);
    bufp->chgIData(oldp+138,(vlSelf->regs[18]),32);
    bufp->chgIData(oldp+139,(vlSelf->regs[19]),32);
    bufp->chgIData(oldp+140,(vlSelf->regs[20]),32);
    bufp->chgIData(oldp+141,(vlSelf->regs[21]),32);
    bufp->chgIData(oldp+142,(vlSelf->regs[22]),32);
    bufp->chgIData(oldp+143,(vlSelf->regs[23]),32);
    bufp->chgIData(oldp+144,(vlSelf->regs[24]),32);
    bufp->chgIData(oldp+145,(vlSelf->regs[25]),32);
    bufp->chgIData(oldp+146,(vlSelf->regs[26]),32);
    bufp->chgIData(oldp+147,(vlSelf->regs[27]),32);
    bufp->chgIData(oldp+148,(vlSelf->regs[28]),32);
    bufp->chgIData(oldp+149,(vlSelf->regs[29]),32);
    bufp->chgIData(oldp+150,(vlSelf->regs[30]),32);
    bufp->chgIData(oldp+151,(vlSelf->regs[31]),32);
    bufp->chgCData(oldp+152,(vlSelf->decoder_2_4__02Ein),2);
    bufp->chgCData(oldp+153,(vlSelf->decoder_2_4__02Eout),4);
    bufp->chgCData(oldp+154,(vlSelf->decoder_4_16__02Ein),4);
    bufp->chgSData(oldp+155,(vlSelf->decoder_4_16__02Eout),16);
    bufp->chgIData(oldp+156,(vlSelf->encoder_32_5__02Ein),32);
    bufp->chgCData(oldp+157,(vlSelf->encoder_32_5__02Eout),5);
...
void Vysyx_25020037_alu___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_25020037_alu___024root__trace_cleanup\n"); );
    // Init
    Vysyx_25020037_alu___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vysyx_25020037_alu___024root*>(voidSelf);
    Vysyx_25020037_alu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
