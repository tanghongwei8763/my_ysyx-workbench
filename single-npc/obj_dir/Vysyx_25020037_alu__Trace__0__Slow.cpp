...
#include "Vysyx_25020037_alu__Syms.h"


VL_ATTR_COLD void Vysyx_25020037_alu___024root__trace_init_sub__TOP__0(Vysyx_25020037_alu___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    Vysyx_25020037_alu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_25020037_alu___024root__trace_init_sub__TOP__0\n"); );
    // Init
    ...
    for (int i = 0; i < 32; ++i) {
        tracep->declBus(c+121+i*1,"regs", true,(i+0), 31,0);
    }
    tracep->declBus(c+153,"decoder_2_4.in", false,-1, 1,0);
    tracep->declBus(c+154,"decoder_2_4.out", false,-1, 3,0);
    tracep->declBus(c+155,"decoder_4_16.in", false,-1, 3,0);
    tracep->declBus(c+156,"decoder_4_16.out", false,-1, 15,0);
    tracep->declBus(c+157,"encoder_32_5.in", false,-1, 31,0);
    tracep->declBus(c+158,"encoder_32_5.out", false,-1, 4,0);
    tracep->pushNamePrefix("decoder_2_4 ");
    tracep->declBus(c+153,"in", false,-1, 1,0);
    tracep->declBus(c+154,"out", false,-1, 3,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("decoder_4_16 ");
    tracep->declBus(c+155,"in", false,-1, 3,0);
    tracep->declBus(c+156,"out", false,-1, 15,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("encoder_32_5 ");
    tracep->declBus(c+157,"in", false,-1, 31,0);
    tracep->declBus(c+158,"out", false,-1, 4,0);
...
VL_ATTR_COLD void Vysyx_25020037_alu___024root__trace_init_top(Vysyx_25020037_alu___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    Vysyx_25020037_alu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_25020037_alu___024root__trace_init_top\n"); );
    // Body
    Vysyx_25020037_alu___024root__trace_init_sub__TOP__0(vlSelf, tracep);
}

VL_ATTR_COLD void Vysyx_25020037_alu___024root__trace_full_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
void Vysyx_25020037_alu___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
void Vysyx_25020037_alu___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/);

VL_ATTR_COLD void Vysyx_25020037_alu___024root__trace_register(Vysyx_25020037_alu___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    Vysyx_25020037_alu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_25020037_alu___024root__trace_register\n"); );
    // Body
    tracep->addFullCb(&Vysyx_25020037_alu___024root__trace_full_top_0, vlSelf);
    tracep->addChgCb(&Vysyx_25020037_alu___024root__trace_chg_top_0, vlSelf);
    tracep->addCleanupCb(&Vysyx_25020037_alu___024root__trace_cleanup, vlSelf);
}

VL_ATTR_COLD void Vysyx_25020037_alu___024root__trace_full_sub_0(Vysyx_25020037_alu___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void Vysyx_25020037_alu___024root__trace_full_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_25020037_alu___024root__trace_full_top_0\n"); );
    // Init
    Vysyx_25020037_alu___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vysyx_25020037_alu___024root*>(voidSelf);
    Vysyx_25020037_alu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
    Vysyx_25020037_alu___024root__trace_full_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void Vysyx_25020037_alu___024root__trace_full_sub_0(Vysyx_25020037_alu___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vysyx_25020037_alu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_25020037_alu___024root__trace_full_sub_0\n"); );
    // Init
    ...
    bufp->fullIData(oldp+119,(vlSelf->inst),32);
    bufp->fullIData(oldp+120,(vlSelf->pc),32);
    bufp->fullIData(oldp+121,(vlSelf->regs[0]),32);
    bufp->fullIData(oldp+122,(vlSelf->regs[1]),32);
    bufp->fullIData(oldp+123,(vlSelf->regs[2]),32);
    bufp->fullIData(oldp+124,(vlSelf->regs[3]),32);
    bufp->fullIData(oldp+125,(vlSelf->regs[4]),32);
    bufp->fullIData(oldp+126,(vlSelf->regs[5]),32);
    bufp->fullIData(oldp+127,(vlSelf->regs[6]),32);
    bufp->fullIData(oldp+128,(vlSelf->regs[7]),32);
    bufp->fullIData(oldp+129,(vlSelf->regs[8]),32);
    bufp->fullIData(oldp+130,(vlSelf->regs[9]),32);
    bufp->fullIData(oldp+131,(vlSelf->regs[10]),32);
    bufp->fullIData(oldp+132,(vlSelf->regs[11]),32);
    bufp->fullIData(oldp+133,(vlSelf->regs[12]),32);
    bufp->fullIData(oldp+134,(vlSelf->regs[13]),32);
    bufp->fullIData(oldp+135,(vlSelf->regs[14]),32);
    bufp->fullIData(oldp+136,(vlSelf->regs[15]),32);
    bufp->fullIData(oldp+137,(vlSelf->regs[16]),32);
    bufp->fullIData(oldp+138,(vlSelf->regs[17]),32);
    bufp->fullIData(oldp+139,(vlSelf->regs[18]),32);
    bufp->fullIData(oldp+140,(vlSelf->regs[19]),32);
    bufp->fullIData(oldp+141,(vlSelf->regs[20]),32);
    bufp->fullIData(oldp+142,(vlSelf->regs[21]),32);
    bufp->fullIData(oldp+143,(vlSelf->regs[22]),32);
    bufp->fullIData(oldp+144,(vlSelf->regs[23]),32);
    bufp->fullIData(oldp+145,(vlSelf->regs[24]),32);
    bufp->fullIData(oldp+146,(vlSelf->regs[25]),32);
    bufp->fullIData(oldp+147,(vlSelf->regs[26]),32);
    bufp->fullIData(oldp+148,(vlSelf->regs[27]),32);
    bufp->fullIData(oldp+149,(vlSelf->regs[28]),32);
    bufp->fullIData(oldp+150,(vlSelf->regs[29]),32);
    bufp->fullIData(oldp+151,(vlSelf->regs[30]),32);
    bufp->fullIData(oldp+152,(vlSelf->regs[31]),32);
    bufp->fullCData(oldp+153,(vlSelf->decoder_2_4__02Ein),2);
    bufp->fullCData(oldp+154,(vlSelf->decoder_2_4__02Eout),4);
    bufp->fullCData(oldp+155,(vlSelf->decoder_4_16__02Ein),4);
    bufp->fullSData(oldp+156,(vlSelf->decoder_4_16__02Eout),16);
    bufp->fullIData(oldp+157,(vlSelf->encoder_32_5__02Ein),32);
    bufp->fullCData(oldp+158,(vlSelf->encoder_32_5__02Eout),5);
