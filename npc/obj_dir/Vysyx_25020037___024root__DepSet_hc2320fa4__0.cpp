...
VL_INLINE_OPT void Vysyx_25020037___024root____Vdpiimwrap_ysyx_25020037__DOT__call_func_TOP(IData/*31:0*/ pc, IData/*31:0*/ dnpc) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_25020037___024root____Vdpiimwrap_ysyx_25020037__DOT__call_func_TOP\n"); );
    // Body
    int pc__Vcvt;
...
VL_INLINE_OPT void Vysyx_25020037___024root____Vdpiimwrap_ysyx_25020037__DOT__ret_func_TOP(IData/*31:0*/ pc) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_25020037___024root____Vdpiimwrap_ysyx_25020037__DOT__ret_func_TOP\n"); );
    // Body
    int pc__Vcvt;
    for (size_t pc__Vidx = 0; pc__Vidx < 1; ++pc__Vidx) pc__Vcvt = pc;
    ret_func(pc__Vcvt);
...
VL_INLINE_OPT void Vysyx_25020037___024root____Vdpiimwrap_ysyx_25020037__DOT__u_sram__DOT__pmem_read_TOP(IData/*31:0*/ addr, IData/*31:0*/ len, IData/*31:0*/ trace_on, IData/*31:0*/ &pmem_read__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_25020037___024root____Vdpiimwrap_ysyx_25020037__DOT__u_sram__DOT__pmem_read_TOP\n"); );
    // Body
    int addr__Vcvt;
...
VL_INLINE_OPT void Vysyx_25020037___024root____Vdpiimwrap_ysyx_25020037__DOT__u_sram__DOT__pmem_write_TOP(IData/*31:0*/ addr, IData/*31:0*/ len, IData/*31:0*/ data, IData/*31:0*/ trace_on) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_25020037___024root____Vdpiimwrap_ysyx_25020037__DOT__u_sram__DOT__pmem_write_TOP\n"); );
    // Body
    int addr__Vcvt;
    for (size_t addr__Vidx = 0; addr__Vidx < 1; ++addr__Vidx) addr__Vcvt = addr;
    int len__Vcvt;
...
VL_INLINE_OPT void Vysyx_25020037___024root____Vdpiimwrap_ysyx_25020037__DOT__u_uart__DOT__difftest_skip_ref_TOP() {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_25020037___024root____Vdpiimwrap_ysyx_25020037__DOT__u_uart__DOT__difftest_skip_ref_TOP\n"); );
    // Body
    difftest_skip_ref();
}
