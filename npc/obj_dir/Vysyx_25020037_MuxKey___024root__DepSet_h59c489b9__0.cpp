...
VL_INLINE_OPT void Vysyx_25020037_MuxKey___024root___ico_sequent__TOP__0(Vysyx_25020037_MuxKey___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vysyx_25020037_MuxKey__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_25020037_MuxKey___024root___ico_sequent__TOP__0\n"); );
    // Body
...
void Vysyx_25020037_MuxKey___024root___eval_ico(Vysyx_25020037_MuxKey___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vysyx_25020037_MuxKey__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_25020037_MuxKey___024root___eval_ico\n"); );
    // Body
    if (vlSelf->__VicoTriggered.at(0U)) {
        Vysyx_25020037_MuxKey___024root___ico_sequent__TOP__0(vlSelf);
    }
}

void Vysyx_25020037_MuxKey___024root___eval_act(Vysyx_25020037_MuxKey___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vysyx_25020037_MuxKey__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_25020037_MuxKey___024root___eval_act\n"); );
}
...
VL_INLINE_OPT void Vysyx_25020037_MuxKey___024root___nba_sequent__TOP__0(Vysyx_25020037_MuxKey___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vysyx_25020037_MuxKey__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_25020037_MuxKey___024root___nba_sequent__TOP__0\n"); );
    // Body
    if (vlSelf->rst) {
        ...
        vlSelf->ysyx_25020037_cpu__DOT__pc = vlSelf->ysyx_25020037_cpu__DOT____Vcellinp__PC__din;
        if (vlSelf->ysyx_25020037_cpu__DOT__lsu_cpu__DOT__lsu_gpr__DOT____Vcellinp__GPR32__BRA__0__KET____DOT__reg_inst____pinNumber5) {
...
void Vysyx_25020037_MuxKey___024root___eval_nba(Vysyx_25020037_MuxKey___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vysyx_25020037_MuxKey__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_25020037_MuxKey___024root___eval_nba\n"); );
    // Body
    if (vlSelf->__VnbaTriggered.at(0U)) {
        Vysyx_25020037_MuxKey___024root___nba_sequent__TOP__0(vlSelf);
...
void Vysyx_25020037_MuxKey___024root___eval(Vysyx_25020037_MuxKey___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vysyx_25020037_MuxKey__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_25020037_MuxKey___024root___eval\n"); );
    // Init
    ...
    while (__VicoContinue) {
        __VicoContinue = 0U;
        Vysyx_25020037_MuxKey___024root___eval_triggers__ico(vlSelf);
        if (vlSelf->__VicoTriggered.any()) {
            ...
            Vysyx_25020037_MuxKey___024root___eval_ico(vlSelf);
        }
    }
    __VnbaIterCount = 0U;
    __VnbaContinue = 1U;
    while (__VnbaContinue) {
        ...
        while (vlSelf->__VactContinue) {
            ...
            Vysyx_25020037_MuxKey___024root___eval_triggers__act(vlSelf);
            if (vlSelf->__VactTriggered.any()) {
                ...
                Vysyx_25020037_MuxKey___024root___eval_act(vlSelf);
            }
        }
...
#ifdef VL_DEBUG
                Vysyx_25020037_MuxKey___024root___dump_triggers__nba(vlSelf);
#endif
                VL_FATAL_MT("vsrc/ysyx_25020037_cpu.v", 1, "", "NBA region did not converge.");
            }
            __VnbaIterCount = ((IData)(1U) + __VnbaIterCount);
            Vysyx_25020037_MuxKey___024root___eval_nba(vlSelf);
        }
    }
}

#ifdef VL_DEBUG
void Vysyx_25020037_MuxKey___024root___eval_debug_assertions(Vysyx_25020037_MuxKey___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vysyx_25020037_MuxKey__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_25020037_MuxKey___024root___eval_debug_assertions\n"); );
    // Body
