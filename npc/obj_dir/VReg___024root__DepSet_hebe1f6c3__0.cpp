...
VL_INLINE_OPT void VReg___024root____Vdpiimwrap_cpu__DOT__ifu_cpu__DOT__pmem_read_TOP(IData/*31:0*/ addr, IData/*31:0*/ len, IData/*31:0*/ &pmem_read__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VReg___024root____Vdpiimwrap_cpu__DOT__ifu_cpu__DOT__pmem_read_TOP\n"); );
    // Body
...
void VReg___024root___eval_triggers__act(VReg___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    VReg___024root___eval_triggers__act\n"); );
    // Body
