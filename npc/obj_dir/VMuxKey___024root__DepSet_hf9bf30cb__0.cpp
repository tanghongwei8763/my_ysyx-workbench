...
#endif
                VL_FATAL_MT("vsrc/MuxKey.v", 2, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/MuxKey.v", 2, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/MuxKey.v", 2, "", "NBA region did not converge.");
            }
