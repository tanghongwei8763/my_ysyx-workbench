...
VL_ATTR_COLD void Vysyx_25020037_cpu___024unit___ctor_var_reset(Vysyx_25020037_cpu___024unit* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vysyx_25020037_cpu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vysyx_25020037_cpu___024unit___ctor_var_reset\n"); );
}
