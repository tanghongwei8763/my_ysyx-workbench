...
ifneq ($(filter $(ARCH),native),)
	@$(CXX) -o $@ -Wl,--whole-archive $(LINKAGE) -Wl,-no-whole-archive $(LDFLAGS_CXX) -Wl,-Map=$(MAP_FILE)
else
	@$(LD) $(LDFLAGS) -o $@ --start-group $(LINKAGE) --end-group -Map=$(MAP_FILE)
endif
	@echo \# Map file generated: $(notdir $(MAP_FILE))
...
clean:
	rm -rf Makefile.html $(WORK_DIR)/build/ $(MAP_FILE)
.PHONY: clean
